                ...
                @if(\Illuminate\Support\Facades\Auth::user()->role==="Administrador")
                        ...
                        <div id="dropdownInformation" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                            ...
                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformationButton">
                                ...
                                <li>
                                    <a href="/dashboard" class="px-4 py-2 block text-gray-100 hover:bg-gray-800 no-underline hover:no-underline">
                                        Dashboard
                                    </a>
                                </li>
                                <li>
                            ...
                            <li class="px-4 py-2 block text-gray-100 hover:bg-gray-800 no-underline hover:no-underline">
