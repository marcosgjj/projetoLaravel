...
class ClienteController extends Controller
{
    ...
    public function areaCliente()
    {
        ...
        return view('areaCliente',
            compact('pedido_aberto', 'pedidos_anteriores'));

    }
    private function existe_compra_aberta(){
    ...
    private function existe_produto_na_compra(){
        return $this->compra->produtos->constains($this->produto);
    }

    private function incrementar_produto_compra(){
